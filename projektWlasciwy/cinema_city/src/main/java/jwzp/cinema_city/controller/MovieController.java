...
import jwzp.cinema_city.security.SecurityConfiguration;
...
public class MovieController {
    ...
    public String confirmReservation(HttpSession session) throws NoSuchFieldException {
        ...
        reservation.setUser(userService.findByUsername((securityConfiguration.getCurrentUserId())));
